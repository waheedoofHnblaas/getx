...
class AddCategoriesWidget extends StatelessWidget {
  AddCategoriesWidget({
    Key? key,
  }) : super(key: key);
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return InkWell(
            onTap: () {
              addItemController.changeCat(controller.categoriesList[index].categoriesId!);
            },
            child: Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15, vertical: 10),
              child: Container(
                decoration: BoxDecoration(
                    color: addItemController.items_cat.text ==
